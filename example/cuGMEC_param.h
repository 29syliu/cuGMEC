...
const std::string inputDir = "/home/imogen/example";
const std::string outputDir = "/home/imogen/example";
const std::string MHDEquilibrium = "ITPA_TAE_128_32.bin";
...
const double B0 = 2.993336759796212;
const double L0 = 10.012878249287333;
const double VA0 = 1.459946004856486e+07;
const double RHO0 = 0.10;
const double RHO1 = 0.90;
const double PSITMAX = 1.50;

/*------------------------------Scale Setting-----------------------------*/

const int hostNums = 1;
const int devNums = 1;
const int gridNx = 128;
const int gridNy = 32;
const int gridNz = 16;
const int NFP = 1;
...
const int perturbRadialIndex = 64;
const mhdReal perturbWidth = 0.05;
const mhdReal perturbAmplitude = 1.0e-9;
...
const velocityType IonVelocity = velocityReal;
const picReal IonMass = 1.0;
const picReal IonChar = 1.0;
const picReal IonBeta = 8.988124662946943e-04;
const picReal IonVmin = 0.0045;
const picReal IonVmax = 0.09;
...
const velocityType AlphaVelocity = velocityReal;
const picReal AlphaMass = 2.0;
const picReal AlphaChar = 1.0;
const picReal AlphaBeta = 0.002565236307978;
const picReal AlphaVmin = 0.065;
const picReal AlphaVmax = 1.3;
...
const disType BeamType = Maxwell;
const spaceType BeamSpace = spaceReal;
const velocityType BeamVelocity = velocityReal;
const picReal BeamMass = 0.0;
const picReal BeamChar = 0.0;
const picReal BeamBeta = 0.0;
const picReal BeamVmin = 0.0;
const picReal BeamVmax = 0.0;
const picReal BeamVb = 0.0;
const picReal BeamDeltaV = 0.0;
const picReal BeamLambda0 = 0.0;
const picReal BeamDeltaLambda2 = 0.0;
...
const int totalSteps = 6000;
const int ratioDt = 1;
const int sortSteps = 5;
const int diagSteps = 1;
const int outputSteps = 200;
