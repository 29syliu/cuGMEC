...
transfer2xy_RZ = @(f, df_drho, df_dtheta, df_dphi, f0) {f/f0, df_drho.*Drho/f0, df_dtheta/f0, df_dphi/f0};

RZ_out = [transfer2xy_RZ(R, dR_drho, dR_dtheta, dR_dphi, L0), transfer2xy_RZ(Z, dZ_drho, dZ_dtheta, dZ_dphi, L0)];
